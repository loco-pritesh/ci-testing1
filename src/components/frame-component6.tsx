...
import * as styles from "./frame-component6.module.css";
...
const FrameComponent6: FunctionComponent = () => {
  ...
  return (
    <section className={styles.conditionSplitter}>
      <header className={styles.valueMultiplier}>
      ...
      <div className={styles.conditionSplitterInner}>
