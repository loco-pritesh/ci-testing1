...
const FrameComponent2: FunctionComponent = () => {
  return (
    <section className={styles.blendModeHandlerWrapper}>
      <div className={styles.blendModeHandler}>
        ...
        <div className={styles.rectangleParent}>
          ...
          <div className={styles.layerContainer}>
            <div className={styles.rectangleGroup}>
              ...
              <button className={styles.freeformShape}>
                <div className={styles.freeformShapeChild} />
